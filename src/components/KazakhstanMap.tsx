...
interface KazakhstanMapProps {
  language: string
  isMobile: boolean
  onCityHover?: (city: { id: string; nameRu: string; nameKk: string; isWarehouse: boolean } | null) => void
}

const KazakhstanMap = ({ language, isMobile, onCityHover }: KazakhstanMapProps) => {
                ...
                <g key={city.id}>
                  ...
                  <circle
                    ...
                    onMouseEnter={() => {
                      ...
                      if (onCityHover) onCityHover({ id: city.id, nameRu: city.nameRu, nameKk: city.nameKk, isWarehouse: city.isWarehouse })
                    }}
                    onMouseLeave={() => {
                      setHoveredCity(null)
                      if (onCityHover) onCityHover(null)
