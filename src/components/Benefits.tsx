...
const Benefits = () => {
  ...
  return (
    <section id="benefits" ref={ref} className="py-12 md:py-20 bg-gray-900 pt-24 md:pt-32">
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-gradient-to-br from-black via-gray-900/50 to-black p-6 md:p-8 rounded-xl border border-gray-800/50 hover:border-accent/50 transition-all hover:shadow-2xl hover:shadow-accent/30 hover:-translate-y-1"
              >
