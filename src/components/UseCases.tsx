...
const UseCases = () => {
  ...
  return (
    <section id="usecases" ref={ref} className="bg-white py-8 md:py-10 lg:py-12">
      <div className="container mx-auto px-4">
        <motion.h2
          initial={{ opacity: 0, y: 50 }}
          animate={isVisible ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.6 }}
          className="mb-5 bg-gradient-to-r from-slate-900 to-slate-600 bg-clip-text text-center text-2xl font-bold text-transparent sm:text-3xl md:mb-6 md:text-4xl lg:mb-8 lg:text-5xl"
        >
          {t('useCases.title')}
        </motion.h2>
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-4 lg:grid-cols-3 lg:gap-5">
          {useCases.map((useCase, index) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-2xl border border-slate-200/70 bg-white shadow-sm transition-all hover:-translate-y-1 hover:border-accent/50 hover:shadow-lg hover:shadow-slate-200/70"
            >
              ...
              <div className="relative z-20 p-3.5 md:p-4">
                ...
                <p className="text-sm leading-snug text-slate-600 md:text-[15px]">
