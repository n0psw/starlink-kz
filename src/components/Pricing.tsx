...
const Pricing = () => {
  ...
  return (
    <section id="pricing" ref={ref} className="py-12 md:py-16 lg:py-20 bg-[color:var(--surface-2)] pt-20 md:pt-24 lg:pt-32">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-base md:text-xl text-slate-600">{t('pricing.subtitle')}</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
          {plans.map((plan, index) => (
            <motion.div
              ...
              className="premium-card p-5 md:p-6 lg:p-8 hover:border-accent/50 transition-all relative hover:shadow-xl hover:shadow-slate-200/70 hover:-translate-y-1"
            >
              ...
              <button
                ...
                className="w-full px-4 py-2.5 md:px-6 md:py-3 bg-gradient-to-r from-accent to-accent/90 hover:from-accent/90 hover:to-accent text-slate-900 text-sm md:text-base font-semibold rounded-full transition-all hover:scale-105 hover:shadow-lg hover:shadow-accent/40 relative z-10"
              >
                {t('pricing.contactUs')}
              </button>
            </motion.div>
