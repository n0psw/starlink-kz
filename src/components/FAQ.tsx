...
const FAQ = () => {
  ...
  const faqs = [
    ...
    {
      question: 'Что входит в комплект при покупке?',
      answer: 'В комплект входит оригинальная спутниковая антенна, Wi-Fi роутер, соединительные кабели и подставка. Оборудование полностью готово к использованию.',
    },
  ]
